...
public class ChangeAccessServlet extends HttpServlet
{
   ...
   protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
   {
      try
      {
         ...
         dDao.deleteAndWrite(model);
         resp.sendRedirect("myfiles.jsp?msg=Accessed Changed for " + sharedEmail + " on " + filename.substring(filename.indexOf("_") + 1));
      }
      catch (Exception e)
      {
         e.printStackTrace();
