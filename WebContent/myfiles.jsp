...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="myfiles.jsp">My Files</a>
  </li>
  <li class="nav-item">
				   				   		...
				   				   		<tr>
												...
												<div class="input-group mb-3">
												  <div class="input-group-prepend">
												    ...
												    <button  style='text-align: left; border: none; width: 100%;' class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-file"></i> <%=file.getFilename().substring(file.getFilename().indexOf("_")+1) %> <img src='uploading.gif' id='gif<%=i %>' style='width: 75px; display: none;' /></button>												    
												...
												<!--  MODALS -->
														<div class="portfolio-modal modal fade" id="reupload<%=i%>"
																		...
																		<div class="container">
																			<div class="row justify-content-center">
																				<div class="col-lg-8">
																					...
																					<form id='frm<%=i %>' action='filereupload?filename=<%=file.getFilename() %>' method=post enctype="multipart/form-data">
																						<label>Upload New Version</label>
																						<input type=file name='file' class='form-control' />
																						<br/>
																						<img src='uploading.gif' id='ugif<%=i %>' style='display: none; width: 100px;'/>
																						<input id='sbtn<%=i %>' onclick='javascript: reupload(<%=i %>);' type=button value='Upload' class='btn btn-primary' />
																					</form>
