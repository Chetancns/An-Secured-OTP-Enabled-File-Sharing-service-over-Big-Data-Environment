...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="addfile.jsp">Add File</a>
  </li>
  <li class="nav-item">
...
<br/>
			...
			<form id='frm' action='fileupload' method=post enctype="multipart/form-data">
				<label>Upload File to HDFS</label>
				<input type=file name='file' class='form-control' />
				<br/>
				<img src='uploading.gif' id='ugif' style='display: none; width: 100px;'/>
				<input id='sbtn' type=button value='Upload' class='btn btn-primary' />
			</form>
